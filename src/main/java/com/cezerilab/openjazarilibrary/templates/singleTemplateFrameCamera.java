...
import org.opencv.core.Core;
     ...
     * @author BAP1
     */
    public class singleTemplateFrameCamera extends javax.swing.JFrame {

        Webcam webcam = null;
        BufferedImage bf = null;
        singleTemplateFrameCamera onlyInstance; //the only instance of this class which
        //will exist per run of the program. The singleton pattern will prevent any re-instantiation of
        //redundant components.

        /**
         * Creates new form TemplateFrameImage2
         */
        public static singleTemplateFrameCamera getTemplateFrameCamera() {
            if (onlyInstance != null) { //if it has already been instantiated, return the object
                return onlyInstance;
            } else {
                onlyInstance = new SingleTemplateFrameCamera(); //if this is the first time instantiating, it will also
                //be the only time this instance is instantiated.
                onlyInstance.initComponents(); //this is a costly function and as such should be done once
                onlyInstance.setExtendedState(getExtendedState() | JFrame.MAXIMIZED_BOTH);
                onlyInstance.System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
                List<Webcam> lst = Webcam.getWebcams();
                if (lst.size() > 0) {
                    onlyInstance.ComboBoxModel model = new DefaultComboBoxModel(lst.toArray());
                    onlyInstance.combo_cam.setModel(model);
                } else {
        ...
        public static void main(String args[]) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(TemplateFrameCamera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    singleTemplateFrameCamera.getTemplateFrameCamera().setVisible(true);
                }
            });
        }
        ...
        private Void getLiveVideoStream() {
            ...
            while (true) {
                if (!btn_online.isSelected()) {
                    if (chk_isLive.isSelected()) {
                        ...
                        if (chk_flip.isSelected()) {
                            bf = FactoryImageProcess.flipVertical(bf);
                        }
                        bf = FactoryImageProcess.drawText(bf, "True FPS:" + fps, 10, 20, Color.yellow);
                ...
                try {
                    ...
                    Logger.getLogger(TemplateFrameCamera.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        ...
        private Void runProcess() {
            ...
            while (btn_online.isSelected()) {
                ...
                bf = FactoryImageProcess.toBGR(bf);

                bf = FactoryImageProcess.rgb2hsv(bf);
                bf = FactoryImageProcess.drawText(bf, "True FPS:" + fps, 10, 20, Color.yellow);
                getPanel().setImage(bf);
                fps = FactoryUtils.fps(t);
                t = System.nanoTime();
        ...
        private void doOfflineProcessing() {
            bf = webcam.getImage();
            bf = FactoryImageProcess.toHSVColorSpace(bf);
            getPanel().setImage(bf);
        }
