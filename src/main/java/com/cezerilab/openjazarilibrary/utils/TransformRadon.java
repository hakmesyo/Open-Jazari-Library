...
public class TransformRadon {
    ...
    public static BufferedImage forwardProjectionImg(BufferedImage img, int numberOfAngles, int numberOfProjections) {
        ...
        int[][] imagePixels = FactoryImageProcess.imageToPixelsInt(img);
        ...
        BufferedImage backImage = FactoryImageProcess.pixelsToImageGray(FactoryUtils.toIntArray2D(FactoryNormalization.normalizeMinMax(projectedData)));
        return backImage;
    }
    ...
    public static BufferedImage backwardProjectionImg(double[][] projArr, int imgSize) {
        ...
        BufferedImage backImage = FactoryImageProcess.pixelsToImageGray(FactoryUtils.toIntArray2D(FactoryNormalization.normalizeMinMax(backProjectedData)));
        return backImage;
    }
    ...
    public static BufferedImage doSheppLoganFilter(BufferedImage img, int numberOfAngles, int numberOfProjections) {
        double[][] dd=FactoryUtils.toDoubleArray2D(FactoryImageProcess.imageToPixelsInt(img));
        ...
        BufferedImage imgRet = FactoryImageProcess.pixelsToImageGray(FactoryUtils.toIntArray2D(d));
        return imgRet;
    }
