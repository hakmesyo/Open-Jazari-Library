...
public class TestIC_CameraObserver extends javax.swing.JFrame implements IC_CameraInterface{
    ...
    private void initComponents() {
        ...
        pan_1 = new com.cezerilab.openjazarilibrary.gui.panel.PanelPicture();
        pan_2 = new com.cezerilab.openjazarilibrary.gui.panel.PanelPicture();
        pan_3 = new com.cezerilab.openjazarilibrary.gui.panel.PanelPicture();
    ...
    public void sendVideoLiveFrame(BufferedImage img, int device_index) {
        img=FactoryImageProcess.resize(img, 320, 240);
        if (device_index==0) {
