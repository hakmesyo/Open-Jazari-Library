...
////            bf = q.doOpenCV_via_OCL(bf);
    ...
    public BufferedImage doOpenCV_via_OCL(BufferedImage img) {
        ...
        BufferedImage out = FactoryImageProcess.ocv_hsvThreshold(img, 14, 70, 150, 255, 150, 255);
    ...
    public BufferedImage doOpenCV(BufferedImage img) {
        ...
        t = FactoryUtils.toc("enterance:", t);
        Mat frame = FactoryImageProcess.ocv_img2Mat(img);
...
//        BufferedImage bf = ImageProcess.ocv_mat2Img(frame);
        BufferedImage bf = FactoryImageProcess.ocv_mat2Img(hsvImage);
        System.out.println("--------------------------------");
        tt = FactoryUtils.toc("overall cost:", tt);
        System.out.println("--------------------------------");
        return bf;
...
//        t = FactoryUtils.toc("medain filter:", t);
        bf = FactoryImageProcess.ocv_hsvThreshold(bf, 14, 50, 150, 255, 150, 255);
//        t = FactoryUtils.toc("hsvThreshold:", t);
        CPoint cp = FactoryImageProcess.getCenterOfGravityGray(bf);
