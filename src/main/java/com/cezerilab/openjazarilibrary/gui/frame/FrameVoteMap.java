...
import com.cezerilab.openjazarilibrary.gui.panel.PanelVoteMap;

/**
 *
 * @author BAP1
 */
public class FrameVoteMap extends javax.swing.JFrame {

    private List<TVoteMap> cm;
    private boolean isSort = true;
    
    public FrameVoteMap(List<TVoteMap> cm) {
        this.cm = cm;
        this.setTitle("Vote Map");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panel_plot = new com.cezerilab.openjazarilibrary.gui.panel.PanelVoteMap(cm);
        ...
        btn_advanced.setText("Visualize");
...
//        new FrameCDataGrid(cm).setVisible(true);
...
//        getPlotPanel().getMatrix().transpose().visualize();
    ...
    public PanelVoteMap getPlotPanel() {
        return (PanelVoteMap) panel_plot;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameVoteMap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrameVoteMap frm = new FrameVoteMap(null);
                frm.setVisible(true);
            }
        });
    }
    ...
    private void savePanel() {
        ...
        if (file != null) {
            FactoryImageProcess.saveGridImage(FactoryImageProcess.getBufferedImage(getPlotPanel()), file.getAbsolutePath());
        } else {
