...
import java.io.File;
import com.cezerilab.openjazarilibrary.gui.panel.PanelImageHistogram;
...
//    }
    ...
    private void initComponents() {
        ...
        panel_plot = new com.cezerilab.openjazarilibrary.gui.panel.PanelImageHistogram(cm);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BufferedImage bf=FactoryImageProcess.imread(".\\images\\t1.bmp");    
