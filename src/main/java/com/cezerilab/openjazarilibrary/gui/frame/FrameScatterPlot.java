...
import java.io.File;
import com.cezerilab.openjazarilibrary.gui.panel.PanelScatterPlot;
...
public final class FrameScatterPlot extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_plot = new com.cezerilab.openjazarilibrary.gui.panel.PanelScatterPlot();
...
//                frm.getScatterPlotPanel().setAxisText(s);
    ...
    private void savePanel() {
        ...
        if (file != null) {
            FactoryImageProcess.saveGridImage(FactoryImageProcess.getBufferedImage(getScatterPlotPanel()), file.getAbsolutePath());
        } else {
