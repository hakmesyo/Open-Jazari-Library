...
import com.cezerilab.openjazarilibrary.gui.panel.PanelPictureAdvanced;
...
//        this.setSize(img.getWidth() + pw, img.getHeight() + ph);
    ...
    public FrameImageAdvanced(CMatrix cm) {
        super(cm.name);
        initComponents();
        BufferedImage img = FactoryImageProcess.pixelsToImageGray(cm.toIntArray2D());
        getPicturePanel().setImage(img, "", this);
        this.setSize(img.getWidth() + pw, img.getHeight() + ph);
    }
    ...
    public FrameImageAdvanced(int[][] data) {
        initComponents();
        BufferedImage img = FactoryImageProcess.pixelsToImageGray(data);
        getPicturePanel().setImage(img, "", this);
        this.setSize(img.getWidth() + pw, img.getHeight() + ph);
    }
    ...
    public FrameImageAdvanced(String filePath) {
        initComponents();
        img = FactoryImageProcess.readImageFromFile(filePath);
    ...
    private void initComponents() {
        ...
        PanelPicture = new com.cezerilab.openjazarilibrary.gui.panel.PanelPictureAdvanced();
    ...
    private PanelPictureAdvanced getPicturePanel() {
        return ((PanelPictureAdvanced) PanelPicture);
    }
    ...
    private void image_listValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_image_listValueChanged
        ...
        try {
            currBufferedImage = FactoryImageProcess.readImageFromFile(txt_folderPath.getText() + "\\" + listImageFile.get(listIndex));
    ...
    private void btn_loadImagesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loadImagesActionPerformed
        ...
        currBufferedImage = FactoryImageProcess.readImageFromFile(txt_folderPath.getText() + "\\" + listImageFile.get(0));
    ...
    private void savePanel() {
        ...
        if (file != null) {
            FactoryImageProcess.saveGridImage(FactoryImageProcess.getBufferedImage(((PanelPicture) PanelPicture)), file.getAbsolutePath());
        } else {
